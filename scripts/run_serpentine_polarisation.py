...
def main() -> None:
    ...
    for key, tortuosity in (('tauInPlane', 1.0), ('tauThroughPlane', 2.0)):
        replace_entry(transport, key, tortuosity)
    ...
    for current_density in args.currents:
        ...
        (case / '0/inletVelocity').write_text(f'inletVelocity {velocity:.12g};\n')
        ...
        for field in ('C_O2', 'fi', 'inletOxygen', 'oxygenDiffusivityMultiplier',
                      'kineticMultiplier', 'contactResistance'):
